...
const translations = {
  en: {
    ...
    'dashboard.manageActiveAlerts': 'Manage Active Alerts',
    'dashboard.adminAlertsDescription': 'Manage all active emergency alerts with admin controls.',
  ...
  el: {
    ...
    'dashboard.manageActiveAlerts': 'Διαχείριση Ενεργών Ειδοποιήσεων',
    'dashboard.adminAlertsDescription': 'Διαχείριση όλων των ενεργών ειδοποιήσεων έκτακτης ανάγκης με χειριστήρια διαχειριστή.',
    'dashboard.noActiveAlerts': 'Δεν υπάρχουν ενεργές ειδοποιήσεις',
