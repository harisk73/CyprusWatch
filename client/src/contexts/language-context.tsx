...
const translations = {
  en: {
    ...
    'profile.yourVillage': 'Your Village',
    'profile.selectVillage': 'Select your village...',
    ...
    'profile.primaryContactName': 'Primary Contact Name',
    'profile.primaryContactPhone': 'Primary Contact Phone',
    'profile.relationship': 'Relationship',
    'profile.selectRelationship': 'Select relationship...',
    'profile.relationshipSpouse': 'Spouse',
    'profile.relationshipParent': 'Parent',
    'profile.relationshipSibling': 'Sibling',
    'profile.relationshipChild': 'Child',
    'profile.relationshipFriend': 'Friend',
    'profile.relationshipOther': 'Other',
    'profile.secondaryContactPhone': 'Secondary Contact Phone',
    'profile.notificationPreferences': 'Notification Preferences',
    'profile.alertTypes': 'Alert Types',
    'profile.emergencyAlerts': 'Emergency Alerts',
    'profile.weatherWarnings': 'Weather Warnings',
    'profile.roadClosures': 'Road Closures',
  ...
  el: {
    ...
    'profile.email': 'Email',
    'profile.phone': 'Αριθμός Τηλεφώνου',
    'profile.locationSettings': 'Ρυθμίσεις Τοποθεσίας',
    'profile.yourVillage': 'Το Χωριό σας',
    'profile.selectVillage': 'Επιλέξτε το χωριό σας...',
    'profile.district': 'Επαρχία',
    'profile.address': 'Διεύθυνση (Προαιρετικό)',
    'profile.addressPlaceholder': 'Εισάγετε τη διεύθυνσή σας...',
    'profile.emergencyContacts': 'Επαφές Έκτακτης Ανάγκης',
    'profile.primaryContactName': 'Όνομα Κύριας Επαφής',
    'profile.primaryContactPhone': 'Τηλέφωνο Κύριας Επαφής',
    'profile.relationship': 'Σχέση',
    'profile.selectRelationship': 'Επιλέξτε σχέση...',
    'profile.relationshipSpouse': 'Σύζυγος',
    'profile.relationshipParent': 'Γονέας',
    'profile.relationshipSibling': 'Αδερφός/ή',
    'profile.relationshipChild': 'Παιδί',
    'profile.relationshipFriend': 'Φίλος',
    'profile.relationshipOther': 'Άλλο',
    'profile.secondaryContactPhone': 'Δευτερεύον Τηλέφωνο Επαφής',
    'profile.notificationPreferences': 'Προτιμήσεις Ειδοποιήσεων',
    'profile.alertTypes': 'Τύποι Ειδοποιήσεων',
    'profile.emergencyAlerts': 'Ειδοποιήσεις Έκτακτης Ανάγκης',
    'profile.weatherWarnings': 'Προειδοποιήσεις Καιρού',
    'profile.roadClosures': 'Κλείσιμο Δρόμων',
    'profile.communityUpdates': 'Ενημερώσεις Κοινότητας',
    'profile.notificationMethods': 'Μέθοδοι Ειδοποιήσεων',
    'profile.browserNotifications': 'Ειδοποιήσεις Περιηγητή',
    'profile.smsNotifications': 'Ειδοποιήσεις SMS',
    'profile.emailNotifications': 'Ειδοποιήσεις Email',
    'profile.quietHours': 'Ώρες Ησυχίας',
    'profile.from': 'Από',
    'profile.to': 'Έως',
